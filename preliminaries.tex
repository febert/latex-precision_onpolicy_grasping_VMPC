...
%%CF.9.29: Do you intend to use the same notation for prediction horizon and planning horizon?
...
%%CF.9.29: the cost for CEM should be scalar -- right now we have multiple. Add \sum_i?
