...
%%CF.9.29: Weird to only have one subsection in a section. Should have 0 or 2.
...
%%CF.9.29: Should describe how this gradual increase is done.
...
%%CF.9.29:  Seems like the architecture description belongs in 4.1